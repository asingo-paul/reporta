    ...
    <div className="min-h-screen bg-dark">
        ...
        <nav className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex justify-between items-center">
            <Link to="/" className="flex items-center space-x-3">
              ...
              <span className="text-xl font-light tracking-widest text-white uppercase">Reporta</span>
            </Link>
            <div className="hidden md:flex items-center space-x-8">
              <a href="#vision" className="text-xs uppercase tracking-widest text-gray-400 hover:text-white transition-colors">
                Vision
              </a>
              <a href="#portfolio" className="text-xs uppercase tracking-widest text-gray-400 hover:text-white transition-colors">
                Features
              </a>
              <a href="#contact" className="text-xs uppercase tracking-widest text-gray-400 hover:text-white transition-colors">
                Pricing
              </a>
            </div>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-6xl mx-auto px-6 text-center">
          <p className="section-title mb-8 animate-fade-in">Intelligent Reporting</p>
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-12 font-light leading-relaxed animate-fade-in" style={{ animationDelay: '0.4s' }}>
          ...
          <p className="text-xs text-gray-600 mt-8 tracking-wider">14-DAY COMPLIMENTARY TRIAL</p>
        </div>
      ...
      {/* Vision Section */}
      <section id="vision" className="py-32 border-t border-gray-900">
      ...
      <section id="portfolio" className="py-32 border-t border-gray-900">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-px bg-gray-900">
            {/* Feature 1 */}
            <div className="bg-dark p-12 group hover:bg-dark-50 transition-colors duration-500">
              <div className="mb-8">
                <div className="w-12 h-12 border border-gray-800 flex items-center justify-center group-hover:border-white transition-colors">
                  <span className="text-xl">01</span>
                </div>
              </div>
              <h3 className="text-2xl font-light tracking-wide text-white mb-4">AI-Powered Insights</h3>
            ...
            <div className="bg-dark p-12 group hover:bg-dark-50 transition-colors duration-500">
              ...
              <h3 className="text-2xl font-light tracking-wide text-white mb-4">Unified Data Sources</h3>
              <p className="text-gray-400 font-light leading-relaxed mb-6">
            ...
            <div className="bg-dark p-12 group hover:bg-dark-50 transition-colors duration-500">
              ...
              <h3 className="text-2xl font-light tracking-wide text-white mb-4">Exquisite Design</h3>
              <p className="text-gray-400 font-light leading-relaxed mb-6">
            ...
            <div className="bg-dark p-12 group hover:bg-dark-50 transition-colors duration-500">
              ...
              <h3 className="text-2xl font-light tracking-wide text-white mb-4">Instant Delivery</h3>
              <p className="text-gray-400 font-light leading-relaxed mb-6">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 mb-12">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300 font-light">Unlimited clients and reports</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-1 h-1 bg-white"></div>
                  <span className="text-gray-300 font-light">AI-powered insights</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-1 h-1 bg-white"></div>
                  <span className="text-gray-300 font-light">All platform integrations</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-1 h-1 bg-white"></div>
                  <span className="text-gray-300 font-light">Custom branding</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-1 h-1 bg-white"></div>
            ...
            <div className="border border-gray-900 p-12">
              <div className="mb-12">
                <p className="text-xs uppercase tracking-ultra-wide text-gray-500 mb-4">Monthly Investment</p>
                <div className="flex items-baseline">
                  <span className="text-6xl font-light text-white">$29</span>
                  <span className="text-gray-500 ml-3">/month</span>
                </div>
              </div>
      ...
      <section className="py-32 border-t border-gray-900">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 font-light leading-relaxed text-lg mb-12 max-w-2xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm font-light tracking-widest text-gray-600 uppercase">Reporta</span>
            </div>
            
            <div className="flex items-center space-x-8">
              <a href="#" className="text-xs uppercase tracking-widest text-gray-600 hover:text-white transition-colors">
                Terms
              </a>
              <a href="#" className="text-xs uppercase tracking-widest text-gray-600 hover:text-white transition-colors">
                Privacy
            ...
            <p className="text-xs text-gray-700 tracking-wider">© 2026 REPORTA</p>
          </div>
        </div>
      </footer>
    </div>
